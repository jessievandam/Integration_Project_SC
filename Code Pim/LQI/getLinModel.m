function [ sys, nonls ] = getLinModel( angle1, angle2 )
%getLinModel Calculate the linearized model around an equilibrium with
%the angle values angle1 and angle2
%   Detailed explanation goes here

syms g L1 L2 m1 m2 I1 I2 c1 c2 Tau b1 b2  M Bc1 Bc2 real
...
nonls = subs(Eq,[g L1 m1 m2 I1 I2 c1 c2 b1 b2 M Bc1 Bc2],[9.83794 0.100000076766013,0.179999924466894,0.0600000383822383,0.0369998475993046,7.76528013495079e-05,0.0599997734003052,0.0450002885575143,1.38025031473599,-9.48404216749001e-06,-6.90462811414762,9.98062277740736e-05,1.36489750177105e-05]);
...
A_eq1 = [0 0 1 0;
         0 0 0 1;
         double(subs(A,[theta;thetad],[angle1;angle2;0;0]))];
B_eq1 = [0;0;double(subs(B,[theta;thetad],[angle1;angle2;0;0]))];
