function dx = nonlinsim(t,x,u,par)
%Simulation for full dynamic model
theta1  = x(1);
theta2  = x(2);
theta1d = x(3);
theta2d = x(4);
...
c1 = par(6); c2 = par(7); 
b1 = par(8); b2 = par(9);  Bc1 = par(10); Bc2 = par(11);
L = par(12); Kt = par(13); R = par(14); Kv = par(15); g = 9.81; M = -7;
