...
load('data_medium_meas_nonlinearv2');
data_th1 = theta1.Data(1:end);
data_th2 = theta2.Data(1:end);
...
error_fullmodel = @(vec) error_fullmodel(vec,theta_0,input,par,data_th1);

par_min_fullmodel_lsq = lsqnonlin(error_fullmodel,vec_est,lb_th1,ub_th1,opt);
