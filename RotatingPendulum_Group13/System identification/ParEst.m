...
time = theta2.time;
time = time(data_start_th2:(3000+data_start_th2-1));
...
figure; hold on
plot(theta2.time(1:(length(theta2_est(1:500)))), theta2_est(1:500),'-.')
plot(theta2.time(1:(length(theta2_est(1:500)))),data(1:500))
...
figure; hold on
plot(theta2.time(1:(length(theta_est_check))),theta_est_check,'-.')
plot(theta2.time(1:(length(theta_est_check))),data_check)
legend('Estimated parameters','Measured data')
xlabel('time [sec]');
ylabel('angle [rad]');
hold off
...
figure; hold on 
plot(theta1.time(1:2000),y0_th1_doublepend_discr,'-.')
plot(theta1.time(1:2000),data_th1_discr)
legend('Estimated parameters','Measured data')
xlabel('time [sec]');
ylabel('angle [rad]');
hold off
...
figure; hold on
plot(theta1.time(1:2000),y0_th2_doublepend_discr,'-.')
plot(theta1.time(1:2000),data_th2_discr)
legend('Estimated parameters','Measured data')
xlabel('time [sec]');
ylabel('angle [rad]');
hold off
