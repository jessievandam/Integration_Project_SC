###########################################################################
## Makefile generated for Simulink model 'ModID_b2_R2017a'. 
## 
## Makefile     : ModID_b2_R2017a.mk
## Generated on : Fri May 10 11:40:42 2019
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ModID_b2_R2017a
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/janneke/OneDrive\ -\ student.tudelft.nl/MSc/Systems&Control/2018-2019/2018-2019\ Q4/SC42035\ -\ Integration\ Project/Integration_Project_SC
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = ModID_b2_R2017a_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ModID_b2_R2017a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/ModID_b2_R2017a_grt_rtw -I"$(START_DIR)/Parameter\ Estimation" -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=ModID_b2_R2017a -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/ModID_b2_R2017a_grt_rtw/ModID_b2_R2017a.c
...
%.o : $(START_DIR)/ModID_b2_R2017a_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ModID_b2_R2017a_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
